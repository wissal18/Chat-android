...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder{
       ...
       void setData(ChatMessage chatMessage){
           binding.idSentMsg.setText(chatMessage.message);
           binding.idSentMsgTime.setText(chatMessage.dateTime);
       }
    }
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMessage chatMessage,Bitmap receiverProfileImage){
            binding.idReceivedMsg.setText(chatMessage.message);
            binding.idReceivedMsgTime.setText(chatMessage.dateTime);
            binding.idRecImgProfile.setImageBitmap(receiverProfileImage);
        }
    }
}
